<?php
	...
	if($spam_email=="ON"){
		...
		mysql_query ("UPDATE  schoolboy SET Fio_schoolboy = '$fio', class='$classes', school = '$school', email = '$email', home_adress = '$location', phone='$mob_number', birthdate='$DOB', gender='$sex', delivery='$spam_email'   WHERE Users_id='$id'");	
